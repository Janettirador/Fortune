...
public class Fortune {
    ...
    public static void main(String[] args) {
       Scanner keyboard = new Scanner(System.in);
        ...
        while (gpa <= 0)
        {
            System.out.println("Now, I knew you were a bit slow from the looks of you, but that's just astonoshing!");
        ...
        System.out.print("That's nice! I love that on Friday's ");
